 ...
 */
public class TennisFragment extends GenericSportsFragment {
...
//    private TableLayout rosterTableLayout;
    ...
    private TennisUpcomingGamesAdapter mTennisUpcomingGamesAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (gender) {
            mServiceIntent.putExtra("gender_preference",
                    "http://hornets.kzoo.edu/sports/mten/2014-15/schedule?print=rss");
        } else {
            mServiceIntent.putExtra("gender_preference",
                    "http://hornets.kzoo.edu/sports/wten/2014-15/schedule?print=rss");
        }
...
//                    tableRowHeight, 10f));
     ...
     */
    public class TennisUpcomingGamesAdapter extends GenericSportsFragment.UpcomingGamesAdapter {

        public TennisUpcomingGamesAdapter(Context context, List<GenericSportsRssItem> items) {
            super(context, items);
        }
    ...
    public class MyResultReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int resultCode, Bundle resultData) {
            ...
            mTennisUpcomingGamesAdapter = new TennisUpcomingGamesAdapter(getActivity(),
                    upcomingEventsList);
            upcomingGamesListView.setAdapter(mTennisUpcomingGamesAdapter);
