 ...
 */
public class SoccerFragment extends GenericSportsFragment{
...
//    private TableLayout rosterTableLayout;
    ...
    private SoccerUpcomingGamesAdapter mSoccerUpcomingGamesAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (gender) {
            mServiceIntent.putExtra("gender_preference",
                    "http://hornets.kzoo.edu/sports/msoc/2014-15/schedule?print=rss");
        } else {
            mServiceIntent.putExtra("gender_preference",
                    "http://hornets.kzoo.edu/sports/wsoc/2014-15/schedule?print=rss");
        }
...
//                    tableRowHeight, 10f));
     ...
     */
    public class SoccerUpcomingGamesAdapter extends GenericSportsFragment.UpcomingGamesAdapter {

        public SoccerUpcomingGamesAdapter(Context context, List<GenericSportsRssItem> items) {
            super(context, items);
        }
    ...
    public class MyResultReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int resultCode, Bundle resultData) {
            ...
            mSoccerUpcomingGamesAdapter = new SoccerUpcomingGamesAdapter(getActivity(),
                    upcomingEventsList);
            upcomingGamesListView.setAdapter(mSoccerUpcomingGamesAdapter);
