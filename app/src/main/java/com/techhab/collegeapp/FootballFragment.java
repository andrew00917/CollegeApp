 ...
 */
public class FootballFragment extends GenericSportsFragment {
...
//    private TableLayout rosterTableLayout;
    ...
    private FootballUpcomingGamesAdapter mFootballUpcomingGamesAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mServiceIntent.putExtra("gender_preference",
                "http://hornets.kzoo.edu/sports/fball/2014-15/schedule?print=rss");
...
//                    tableRowHeight, 10f));
     ...
     */
    public class FootballUpcomingGamesAdapter extends UpcomingGamesAdapter {

        public FootballUpcomingGamesAdapter(Context context, List<GenericSportsRssItem> items) {
            super(context, items);
        }
    ...
    public class MyResultReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int resultCode, Bundle resultData) {
            ...
            mFootballUpcomingGamesAdapter = new FootballUpcomingGamesAdapter(getActivity(),
                    upcomingEventsList);
            upcomingGamesListView.setAdapter(mFootballUpcomingGamesAdapter);
